...
// //     // console.log(prod);
// //     for(let obj in product[prod]){
// //         console.log(obj,product[prod][obj]);
...
// //     },
// // ]
// // let sortedarrobj = fakeproducts.sort((a,b)=>a.price -b.price).map((v)=>){
// //     if (v.id === 1) {
// //         return{...v}
// //     }
// // }
...
// //     }
// // ]
// // averagesalary = employee.reduce((acc,emp)=>acc+emp.salary,0)/employee.length
...
// //q3
// // let set = new Set([1,1,1,2,2,2,4,4,5])
// // console.log(set);

// //q4
// // let Arr1 = new Set([1,2,3,4]);
// // let Arr2 = new Set([1,2,3,4,5,3]);
// // let uniquemyArr = [...new Set([...Arr1,...Arr2])]
// // console.log(uniquemyArr);

// // let set = new set ([1,1,1,1,2,3,3,4,5,5,6,6,7,8]);

// //object ka sath hama extra space milta hai usa ham proto khata hai it carries reference from any other values if not find in thier own object then it search in old object
// // let user1= {
// //     name:"raunak",
// //     age:18,
// //     printname(){
...
// user2.printname()
// user1.printname()
// object referencing= call , byind ,apply

// create 3 object in voice 1 in voic2 and voic3 which has name , emalil, password , order id 
// crearte a function which print alll the information of invoice
// function printinvoice(){
//     console.log(this.name,this.emailid,this.password,this.orderid);
    
// }

// let invoice1 = {
//     name:"raunak",
//     emailid:"raunabamotra4@gmail.com",
//     password:1234,
//     orderid:43443
// }
// let invoice2 = {
//    name:"aakash",
//     emailid:"aaksah4@gmail.com",
//     password:1224,
//     orderid:45643
// }
// let invoice3 = {
//    name:"lakshay",
//     emailid:"lakshay4@gmail.com",
//     password:1324,
//     orderid:45683
// }

// printinvoice.call(invoice1)
// printinvoice.apply(invoice2)
// printinvoice.bind(invoice3)()

// arrow function this refer to window


//create a function which creates or return  a object 
//first name , last name,email,age,addres,and about is afunction which return first name and last name is 18 function
// let user1 ={
//     firstname:"raunak",
//     lastname:"bamotra",
//     email:"raunakbamotra4@gmail.com",
//     age:18,
...
// }
// new keyword = it creates a empty object automatically
// it creates a reference or linkage between  proto and function prototype and also it return automatically
